...
from constants import IMAGE_SIZE, FPS

def images_to_video(image_folder_path, video_duration):
...
def generate_video(resized_images, video_folder, video_duration):
    clips = [ImageClip(m).set_duration(video_duration/2)for m in resized_images]
